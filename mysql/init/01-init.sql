...
CREATE DATABASE IF NOT EXISTS banking_voucher_db;
...
CREATE USER IF NOT EXISTS 'voucher_service'@'%' IDENTIFIED BY 'voucher123';
...
GRANT ALL PRIVILEGES ON banking_voucher_db.* TO 'voucher_service'@'%';
